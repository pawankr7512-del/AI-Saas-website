...
export async function scrapeURL(url) {
    ...
    try {
        console.log("[SCRAPER] Starting scrape for:", url);
           ...
           console.log("[SCRAPER] BrowserBase session created");
           ...
           try {
            ...
            console.log("[SCRAPER] Navigation completed");
           } catch (navError) {
            console.error("[SCRAPER] Navigation error:", navError.message);
...
images: {
    total: allImage.length,
    missingAlt,
    withAlt: allImage.length - missingAlt,
},
