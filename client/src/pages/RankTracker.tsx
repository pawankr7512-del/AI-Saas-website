        ...
        try {
            ...
            const pollInterval = setInterval(async () => {
                try {
                    ...
                    if (
                        check.data.tracking.status !== "checking"
                    ) {
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">
                            Track your keyword rankings on
                            Google — updated daily.
                        </p>
                    </div>
                ...
                {loading ? (
                    ...
                    <div className="glass rounded-2xl p-12 text-center">
                        ...
                        <p className="text-sm text-muted-foreground mb-6">
                            Add your first keyword and URL
                            to start tracking your Google
                            rankings.
                        </p>
                    </div>
                ) : (
                    <div className="space-y-3">
                        {processedData.map((kw) => {
                            ...
                            return (
                                <div
                                    key={kw._id}
                                    className={`glass rounded-xl p-5 hover:bg-muted/50 transition-all ${
                                        !kw.active
                                            ? "opacity-50"
                                            : ""
                                    }`}
