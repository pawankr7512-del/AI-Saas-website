...
export default function Report() {
    ...
    const fetchAnalysis = async () => {
        try {
            ...
            if(res.data.success) {
                ...
                console.log("Analysis data received:", analysisData.status);
                ...
                if(analysisData.status === "failed") {
                    const errorMsg = analysisData.issues && analysisData.issues.length > 0 
                        ? analysisData.issues[0].recommendation 
    ...
    const criticalCount = analysis.issues?.filter((i) => i.severity === "high").length || 0;
    const warningCount = analysis.issues?.filter((i) => i.severity === "medium").length || 0;
    const infoCount = analysis.issues?.filter((i) => i.severity === "low").length || 0;
                            ...
                            <div className="bg-card border border-border rounded-2xl p-6">
                                ...
                                <div className="space-y-2">
                                    {["h1", "h2", "h3", "h4", "h5", "h6"].map((tag) => {
                                        const count = (analysis.headings?.[tag as keyof typeof analysis.headings] as number) || 0;
                                        const maxBar = Math.max(
                                            (analysis.headings?.h1 || 0),
                                            (analysis.headings?.h2 || 0),
                                            (analysis.headings?.h3 || 0),
                                            (analysis.headings?.h4 || 0),
                                            (analysis.headings?.h5 || 0),
                                            (analysis.headings?.h6 || 0),
                                            1
                                        );
                                        return (
                                ...
                                {analysis.headings?.h1Texts && analysis.headings.h1Texts.length > 0 && (
                            ...
                            <div className="bg-card border border-border rounded-2xl p-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center p-3 bg-muted/50 border border-border rounded-xl">
                                        ...
                                        <span className="font-bold text-foreground">{(analysis.headings?.h1 || 0) + (analysis.headings?.h2 || 0) + (analysis.headings?.h3 || 0) + (analysis.headings?.h4 || 0) + (analysis.headings?.h5 || 0) + (analysis.headings?.h6 || 0)}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {analysis.issues && analysis.issues.length > 0 ? (
                                <>
                                    ...
                                    <div className="flex items-center gap-3 mb-4 flex-wrap">
                                        ...
                                        <span className="severity-critical px-2.5 py-1 rounded-full text-xs font-semibold">{criticalCount} High</span>
                                        <span className="severity-warning px-2.5 py-1 rounded-full text-xs font-semibold">{warningCount} Medium</span>
                                        <span className="severity-info px-2.5 py-1 rounded-full text-xs font-semibold">{infoCount} Low</span>
                                    </div>
