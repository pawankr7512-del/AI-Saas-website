...
export default function Login({ state }: { state: string }) {
    ...
    const handleSubmit = async (e: React.SubmitEvent) => {
        ...
        if(result.success){
            ...
            toast.error(result.message || (isLoginState ? "Login failed" : "Registration failed"))
        }
        setLoading(false)
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <Link to="/" className="flex items-center justify-center gap-2 group mb-10">
                        ...
                        <span className="text-xl tracking-tight text-foreground">Velora Studio</span>
                    </Link>
                </div>
                ...
                <div className="bg-card border border-border rounded-2xl p-8">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="text-center py-5">
                            ...
                            <p className="text-muted-foreground text-sm mt-1">{isLoginState ? "Sign in to your" : "Create an"} Velora Studio account</p>
                        </div>
